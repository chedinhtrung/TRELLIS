...
from .geometry import alignment_payload, connected_components, prepare_candidate_records


from . import FINAL_METHOD
...
def main() -> None:
    ...
    copied_policy = args.output_dir / "policy.json"
    if args.policy.resolve() != copied_policy.resolve():
        shutil.copyfile(args.policy, copied_policy)
