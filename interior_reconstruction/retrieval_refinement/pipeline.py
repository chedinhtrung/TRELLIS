...
def generate_unified_candidates(
    ...
    # PLY support is imported only when geometry is generated, keeping the
    # selector/model helpers usable in lightweight unit tests.
    from .support import interior
