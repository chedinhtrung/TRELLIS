...
def _render_cond(file_path, sha256, output_dir, num_views, resolution, denoise, ssaa, log_file, override=False):
...
if __name__ == "__main__":
    ...
    if opt.instances is None:
        ...
        if not opt.override and "cond_rendered" in metadata.columns:
