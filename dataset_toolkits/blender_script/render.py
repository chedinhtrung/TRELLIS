...
def init_render(engine='CYCLES', resolution=512, geo_mode=False, samples=128, denoise=False):
...
def main(arg):
    ...
    # Initialize context
    init_render(engine=arg.engine, resolution=arg.resolution, geo_mode=arg.geo_mode, samples=arg.samples, denoise=arg.denoise)
